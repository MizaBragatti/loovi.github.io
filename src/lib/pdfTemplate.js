// Template de PDF portado do sistema estático (js/templates.js) para o sistema 100% API.
// Mesmo layout/estilo (marca Loovi, seções de benefícios, colisão, vidros, dados do executivo),
// mas os dados do vendedor são recebidos por parâmetro em vez de variáveis globais.
...
export const htmlBeneficiosInicio = "<div _ngcontent-ng-c2012710688=\"\" class=\"s-hero\">\r\n";
export const htmlContainerInicio = "<div _ngcontent-ng-c2012710688=\"\" class=\"container\" style=\"margin-top: 50px;\">\r\n";
export const htmlDadosPlanoInicio = "<div _ngcontent-ng-c2012710688=\"\" class=\"dados-plano\" style=\"grid-template-columns: repeat(2, 1fr);\">\r\n";

export function htmlEssencial(plano) {
  return "<div _ngcontent-ng-c2012710688=\"\" class=\"esquerdo\">\r\n" +
    ...
    "           <p _ngcontent-ng-c2012710688=\"\" class=\"titulo-cobertura\">Furto e roubo</p>\r\n" +
    "       </div>\r\n" +
...
export const htmlDireitoFim = "</div>";
export const htmlDadosPlanoFim = "</div>";

// Portado de preencherHTMLBaixo() (js/templates.js do sistema estático), mas recebe o
...
export function montarHtmlBaixo(vendedor) {
  ...
  return "<div _ngcontent-ng-c2012710688=\"\" class=\"valor-assinatura-recorrente\">\r\n" +
    ...
    "   </div>" +
    "   <a _ngcontent-ng-c2012710688=\"\"  href=\"https://wa.me/55" + tel + "\" target=\"_blank\" rel=\"noopener noreferrer\">" +
    "       <div _ngcontent-ng-c2012710688=\"\" class=\"email\">" +
...
export const htmlContainerFim = "</div>";

export const htmlBeneficiosFim = "</div>";
